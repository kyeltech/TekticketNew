	...
	// Related Events
	//-------------------------------
	if($('#et-related-events2 .owl-carousel').length){
		$('#et-related-events2 .owl-carousel').owlCarousel({
			loop:true,
			nav:true,
			dots:false,
			autoplay: true,
	...
	if($('#et-related-event5 .owl-carousel').length){
		$('#et-related-event5 .owl-carousel').owlCarousel({
			loop:true,
			// nav:true,
			dots:true,
			autoplay: true,
